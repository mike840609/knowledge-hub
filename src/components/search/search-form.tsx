  ...
  return (
    <form action={`/w/${workspaceId}/search`} method="get" role="search" className="space-y-3">
      <div className="flex items-center gap-2 rounded-lg border border-kh-border bg-kh-bg pl-3 transition-colors focus-within:border-kh-focus focus-within:ring-2 focus-within:ring-kh-focus">
        ...
        <input id="search-q" name="q" type="search" defaultValue={q} autoComplete="off" placeholder="Search documents…" className="h-11 min-w-0 flex-1 bg-transparent text-sm text-kh-text outline-none placeholder:text-kh-text-muted" />
        <Button type="submit" className="m-1 min-h-9 px-4 py-1.5">Search</Button>
      </div>
      <div className="flex flex-wrap items-center gap-2">
        <label className="inline-flex min-h-9 items-center gap-2 rounded-md border border-kh-border bg-kh-bg-subtle pl-3 pr-2 text-xs text-kh-text-muted" htmlFor="search-scope">
          Scope
          <select
            id="search-scope"
            name="scope"
            defaultValue={scope}
            className="max-w-[11rem] bg-transparent py-1.5 text-xs font-medium text-kh-text outline-none focus-visible:ring-2 focus-visible:ring-kh-focus"
          >
        ...
        {scope === "workspace" && (
          <label className="inline-flex min-h-9 items-center gap-2 rounded-md border border-kh-border bg-kh-bg-subtle pl-3 pr-2 text-xs text-kh-text-muted" htmlFor="search-source">
            Source
            <select
              id="search-source"
              name="source"
        ...
        <label className="inline-flex min-h-9 items-center gap-2 rounded-md px-2 text-xs text-kh-text-muted hover:bg-kh-bg-hover">

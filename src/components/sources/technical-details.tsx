...
export function TechnicalDetails({ source }: { source: SourceView }) {
  ...
  return (
    <details className="rounded-md border border-kh-border bg-kh-bg px-3 py-2.5">
      <summary className="cursor-pointer rounded text-sm font-medium text-kh-text focus:outline-none focus-visible:ring-2 focus-visible:ring-kh-focus">Technical details</summary>

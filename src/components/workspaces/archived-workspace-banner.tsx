...
export function ArchivedWorkspaceBanner({
  ...
  return (
    <aside
      className="border-b border-kh-warning-border bg-kh-warning-bg px-6 py-3 text-body"
      aria-label="Archived workspace"
    >
      <p>This workspace is archived. Knowledge remains available in read-only mode.</p>
      {canRestore && (
        <Button
          className="mt-2"
